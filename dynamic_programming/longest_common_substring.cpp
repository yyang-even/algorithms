...
SIMPLE_TEST(LongestCommonSubstring, TestSAMPLE1, EXPECTED1.size(), SAMPLE1_X,
            SAMPLE1_Y);
SIMPLE_TEST(LongestCommonSubstring, TestSAMPLE2, EXPECTED2.size(), SAMPLE2_X,
            SAMPLE2_Y);
SIMPLE_TEST(LongestCommonSubstring, TestSAMPLE3, EXPECTED3.size(), SAMPLE3_X,
            SAMPLE3_Y);
