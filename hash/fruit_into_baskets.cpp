...
/**
 * @reference   Fruits Into Baskets II
 *              https://leetcode.com/problems/fruits-into-baskets-ii/
 *
 * @reference   Fruits Into Baskets III
 *              https://leetcode.com/problems/fruits-into-baskets-iii/
 *
 * You are given two arrays of integers, fruits and baskets, each of length n, where fruits[i]
 * represents the quantity of the ith type of fruit, and baskets[j] represents the capacity of the jth
 * basket.
