 ...
 */
auto PostorderTraversal_Iterative_OneStack_Count(BinaryTree::Node::PointerType
                                                 current_node,
                                                 BinaryTree::ArrayType &outputs) {
...
auto LevelOrderTraversal_LevelAware(const BinaryTree::Node::PointerType root_node,
                                    BinaryTree::ArrayType &outputs) {
    LevelOrderTraversal_LevelAware_Helper(root_node, [&outputs](const BinaryTree::Node &
    node) {
        outputs.push_back(node.value);
        return true;
    });
