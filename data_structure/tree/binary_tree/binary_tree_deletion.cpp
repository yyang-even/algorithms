...
const auto SAMPLE1_LHS = BinaryTreeDeletion_Subtree(CloneBinaryTree(SAMPLE0),
                                                    5).GetRoot();
const auto SAMPLE1_RHS = BinaryTreeDeletion_BottomShrink(CloneBinaryTree(SAMPLE0),
                                                         5).GetRoot();
