...
/**
 * @reference   Inorder Tree Traversal without Recursion
...
inline auto testInorderTraversal_Recursive(const BinaryTree::Node::PointerType root) {
    BinaryTree::ArrayType outputs;
 ...
 * original BST is changed to the original key plus the sum of all keys greater than the original key in
 * BST.
...
/**
 * @reference   Inorder Successor in Binary Search Tree
 ...
 *              Questions 4.6.
 */
auto InorderSuccessor_WithParentPointer(const BinaryTreeNodeWithParent::PointerType x_node) {
    if (not x_node) {
        return x_node;
    }
 ...
 *      given as part of the constructor. The pointer should be initialized to a non-existent number
 ...
 * That is, there will be at least
 ...
 * You may assume that next() and prev() calls will always be valid. That is, there will be at least a
 * next/previous number in the in-order traversal when next()/prev() is called.
...
SIMPLE_TEST(InorderSuccessor_WithoutParentPointer, TestSAMPLE1, SAMPLE1->right, SAMPLE1, SAMPLE1);
SIMPLE_TEST(
    InorderSuccessor_WithoutParentPointer, TestSAMPLE2, nullptr, SAMPLE1, MaximumNode(SAMPLE1));
SIMPLE_TEST(InorderSuccessor_WithoutParentPointer,
            TestSAMPLE3,
            SAMPLE1->left,
            SAMPLE1,
            MinimumNode(SAMPLE1));
...
SIMPLE_TEST(InorderSuccessor_WithParentPointer, TestSAMPLE1, SAMPLE_P1->right, SAMPLE_P1);
SIMPLE_TEST(InorderSuccessor_WithParentPointer, TestSAMPLE2, nullptr, MaximumNode(SAMPLE_P1));
SIMPLE_TEST(InorderSuccessor_WithParentPointer,
            TestSAMPLE3,
            SAMPLE_P1->left,
            MinimumNode(SAMPLE_P1));


THE_BENCHMARK(InorderPredecessor_WithoutParentPointer, SAMPLE1, SAMPLE1);

SIMPLE_TEST(
    InorderPredecessor_WithoutParentPointer, TestSAMPLE1, SAMPLE1->left->right, SAMPLE1, SAMPLE1);
SIMPLE_TEST(
    InorderPredecessor_WithoutParentPointer, TestSAMPLE2, SAMPLE1, SAMPLE1, MaximumNode(SAMPLE1));
SIMPLE_TEST(
    InorderPredecessor_WithoutParentPointer, TestSAMPLE3, nullptr, SAMPLE1, MinimumNode(SAMPLE1));
...
SIMPLE_TEST(InorderSuccessor_Recursive, TestSAMPLE1, SAMPLE1C->right, SAMPLE1C, SAMPLE1C);
SIMPLE_TEST(InorderSuccessor_Recursive, TestSAMPLE2, nullptr, SAMPLE1C, SAMPLE1C->right);
SIMPLE_TEST(
    InorderSuccessor_Recursive, TestSAMPLE3, SAMPLE1C->left, SAMPLE1C, LeftmostNode(SAMPLE1C));
