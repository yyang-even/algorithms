...
/**
 * @reference   Similar String Groups
 ...
 * Notice that "tars" and "arts" are in the same group even though they are not similar.  Formally, each
 * group is such that a word is in the group if and only if it is similar to at least one other word in
 * the group.
 ...
 *
 * @tags    #graph #connected-components #disjoint-set
 */
