...
auto MedianOfRunningintegers(const ArrayType &ints){
    ...
    std::priority_queue<ArrayType::value_type, std::vector<ArrayType::value_type>, std::greater<ArrayType::value_type> > greater_half;
...
const ArrayType SINGLE_ARRAY = {1};
const ArrayType EVEN_ARRAY = {1, 3};
const std::vector<double> EXPECTED_EVEN = {1, 2};
const ArrayType ODD_ARRAY = {1, 2, 3};
const std::vector<double> EXPECTED_ODD = {1, 1.5, 2};
...
SIMPLE_TEST(MedianOfRunningintegers, TestSingle, SINGLE_ARRAY, SINGLE_ARRAY);
SIMPLE_TEST(MedianOfRunningintegers, TestEven, EXPECTED_EVEN, EVEN_ARRAY);
SIMPLE_TEST(MedianOfRunningintegers, TestOdd, EXPECTED_ODD, ODD_ARRAY);
