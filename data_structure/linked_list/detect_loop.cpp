...
SIMPLE_TEST(FindTheOnlyRepeatingElement_Sorted_BinarySearch, TestFront,
            SAMPLE1S.front(),
            SAMPLE1S);
SIMPLE_TEST(FindTheOnlyRepeatingElement_Sorted_BinarySearch, TestBack, SAMPLE2S.back(),
            SAMPLE2S);
