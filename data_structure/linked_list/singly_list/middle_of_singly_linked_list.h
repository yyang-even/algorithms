...
static inline auto
GetBeforeMiddle_TwoPointersSTL(const std::forward_list<int>::const_iterator cbefore_begin,
 ...
 */
static inline auto GetMiddle_TwoPointers_STL(const std::forward_list<int>::const_iterator cbegin,
                                             const std::forward_list<int>::const_iterator cend) {
