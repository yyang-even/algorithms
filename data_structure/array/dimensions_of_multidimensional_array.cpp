...
void DimensionsOfMultidimensionalArray(const T(&)[row_size], ArrayType &outputs) {
    outputs.push_back(row_size);
}

template <typename T, std::size_t row_size, std::size_t column_size>
void DimensionsOfMultidimensionalArray(const T(&elements)[row_size][column_size],
                                       ArrayType &outputs) {
    outputs.push_back(row_size);
...
#define TestDimensionsOfTwoDimensionalArray(funcName, testName, dimension1, dimension2) namespace { \
    TEST(DimensionsOfTwoDimensionalArrayTest, testName) {                                           \
        ArrayType outputs;                                                                          \
        const int elements[dimension1][dimension2] = {};                                            \
...
#define TestDimensionsOfThreeDimensionalArray(funcName, testName, dimension1, dimension2, dimension3) namespace {   \
    TEST(DimensionsOfThreeDimensionalArrayTest, testName) {                                                         \
        ArrayType outputs;                                                                                          \
        const int elements[dimension1][dimension2][dimension3] = {};                                                \
        funcName(elements, outputs);                                                                                \
                                                                                                                    \
...
TestDimensionsOfTwoDimensionalArray(DimensionsOfMultidimensionalArray, TestSAMPLE1, 5,
                                    8);
TestDimensionsOfThreeDimensionalArray(DimensionsOfMultidimensionalArray, TestSAMPLE2, 5,
                                      8, 3);
