...
auto MedianOf4(const ArrayType::value_type smaller_one,
    ...
    return std::make_pair(std::max(smaller_one, smaller_two), std::min(greater_one,
                          greater_two));
}
...
auto MedianOfTwoSortedArrays_SameSize(const ArrayType &array_one,
    ...
    return MedianOfTwoSortedArrays_SameSize(array_one.cbegin(), array_two.cbegin(),
                                            array_one.size());
}
 ...
 *              https://www.geeksforgeeks.org/median-of-two-sorted-arrays-of-different-sizes-set-1-linear/
 */
double MedianOfTwoSortedArrays_DiffSize_Complex(const ArrayType::const_iterator
                                                &cbegin_shorter,
...
SIMPLE_TEST(MedianOfTwoSortedArrays_SameSize, TestSAMPLE1, 16, SAMPLE1_ONE,
            SAMPLE1_TWO);
...
SIMPLE_BENCHMARK(MedianOfTwoSortedArrays_DiffSize_Merge, Sample1, SAMPLE4_ONE,
                 SAMPLE4_TWO);
...
SIMPLE_BENCHMARK(MedianOfTwoSortedArrays_DiffSize_Complex, Sample1, SAMPLE4_ONE,
                 SAMPLE4_TWO);
