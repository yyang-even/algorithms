 ...
 */
auto BinarySearch_SinglyList(const std::forward_list<ArrayType::value_type>
                             &singly_list,
                             const ArrayType::value_type x) {
...
MUTUAL_SIMPLE_TEST(BinarySearch_STL_Lower, BinarySearch_Recursive, TestSample1, ARRAY1,
                   10);
SIMPLE_TEST(BinarySearch_Recursive, TestLast, std::prev(ARRAY1.cend()), ARRAY1,
            ARRAY1.back());
...
MUTUAL_SIMPLE_TEST(BinarySearch_STL_Lower, BinarySearch_Iterative, TestSample1, ARRAY1,
                   10);
SIMPLE_TEST(BinarySearch_Iterative, TestLast, std::prev(ARRAY1.cend()), ARRAY1,
            ARRAY1.back());
...
SIMPLE_TEST(BinarySearch_Meta, TestLast, std::prev(ARRAY1.cend()), ARRAY1,
            ARRAY1.back());
...
MUTUAL_SIMPLE_TEST(BinarySearch_STL_Lower, BinarySearch_Uniform5, TestSample1, ARRAY1,
                   10);
SIMPLE_TEST(BinarySearch_Uniform5, TestLast, std::prev(ARRAY1.cend()), ARRAY1,
            ARRAY1.back());
...
SIMPLE_TEST(BinarSearch_First_Iterative, TestEmpty, ARRAY_EMPTY.cend(), ARRAY_EMPTY,
            10);
SIMPLE_TEST(BinarSearch_First_Iterative, TestBegin2, ARRAY1.cbegin(), ARRAY1,
            ARRAY1.front());
...
SIMPLE_TEST(BinarSearch_First_Iterative, TestBegin3, VALUES3.cbegin(), VALUES3,
            VALUES3.front());
...
SIMPLE_TEST(BinarySearch_First_Recursive, TestEmpty, ARRAY_EMPTY.cend(), ARRAY_EMPTY,
            10);
SIMPLE_TEST(BinarySearch_First_Recursive, TestBegin2, ARRAY1.cbegin(), ARRAY1,
            ARRAY1.front());
...
SIMPLE_TEST(BinarySearch_First_Recursive, TestBegin3, VALUES3.cbegin(), VALUES3,
            VALUES3.front());
...
SIMPLE_TEST(BinarSearch_Last_Iterative, TestBegin2, ARRAY1.cbegin(), ARRAY1,
            ARRAY1.front());
...
SIMPLE_TEST(BinarySearch_Last_Recursive, TestEmpty, ARRAY_EMPTY.cend(), ARRAY_EMPTY,
            10);
SIMPLE_TEST(BinarySearch_Last_Recursive, TestBegin2, ARRAY1.cbegin(), ARRAY1,
            ARRAY1.front());
...
SIMPLE_TEST(UpperBound_BinarySearch, TestBegin2, ARRAY1.cbegin(), ARRAY1,
            ARRAY1.front() - 1);
...
SIMPLE_TEST(UpperBound_BinarySearch, TestLast3, VALUES3.cend(), VALUES3,
            VALUES3.back());
...
SIMPLE_TEST(GreatestLesser_BinarySearch, TestEmpty, ARRAY_EMPTY.cend(), ARRAY_EMPTY,
            10);
SIMPLE_TEST(GreatestLesser_BinarySearch, TestBegin2, ARRAY1.cbegin(), ARRAY1,
            ARRAY1.front() + 1);
MUTUAL_SIMPLE_TEST(GreatestLesser_STL, GreatestLesser_BinarySearch, TestSample1, ARRAY1,
                   10);
...
SIMPLE_TEST(BinarySearch_Randomized_Iterative, TestLast, std::prev(ARRAY1.cend()),
            ARRAY1,
            ARRAY1.back());
SIMPLE_TEST(BinarySearch_Randomized_Iterative, TestNotExist, ARRAY1.cend(), ARRAY1,
            999);
...
SIMPLE_TEST(BinarySearch_SinglyList, TestLast, std::next(LIST1.cbegin(),
                                                         ARRAY1.size() - 1),
            LIST1, ARRAY1.back());
