...
SIMPLE_TEST(LinearSearch_Iterative, TestBegin, VALUES2.cbegin(), VALUES2,
            VALUES2.front());
MUTUAL_SIMPLE_TEST(LinearSearch_STL, LinearSearch_Iterative, TestSample1, VALUES2, 110);
SIMPLE_TEST(LinearSearch_Iterative, TestLast, std::prev(VALUES2.cend()), VALUES2,
            VALUES2.back());
...
SIMPLE_TEST(LinearSearch_Recursive, TestBegin, VALUES2.cbegin(), VALUES2,
            VALUES2.front());
MUTUAL_SIMPLE_TEST(LinearSearch_STL, LinearSearch_Recursive, TestSample1, VALUES2, 110);
SIMPLE_TEST(LinearSearch_Recursive, TestLast, std::prev(VALUES2.cend()), VALUES2,
            VALUES2.back());
...
SIMPLE_TEST(LinearSearch_Sentinel, TestLast, VALUES2.size() - 1, VALUES2,
            VALUES2.back());
