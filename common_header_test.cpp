...
SIMPLE_TEST(VectorFunction, TestInitializerReturn, initializer_list_single_value,
            initializer_list_single_value);
SIMPLE_TEST(VectorFunction, TestVariable, vector_single_value, vector_single_value);
...
SIMPLE_TEST(ListFunction, TestInitializerReturn, initializer_list_single_value,
            initializer_list_single_value);
SIMPLE_TEST(ListFunction, TestVariable, list_single_value, list_single_value);
