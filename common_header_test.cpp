...
SIMPLE_TEST(TwoArgumentsFunction, TestSignedVariable, signed_value, signed_value,
            signed_value);
...
SIMPLE_BENCHMARK(ThreeArgumentsFunction, Sample2, signed_value, signed_value,
                 signed_value);

SIMPLE_TEST(ThreeArgumentsFunction, TestConstant, 5, 5, 5, 5);
SIMPLE_TEST(ThreeArgumentsFunction, TestSignedVariable, signed_value, signed_value,
            signed_value,
            signed_value);

MUTUAL_SIMPLE_TEST(ThreeArgumentsFunction, ThreeArgumentsFunction, TestConstant, 5, 5,
                   5);
...
MUTUAL_SIMPLE_TEST(SingleBuiltinArgumentFunction, SignedUnsignedFunction, TestConstant,
                   5);
MUTUAL_SIMPLE_TEST(SingleBuiltinArgumentFunction, SignedUnsignedFunction,
                   TestSignedVariable,
                   signed_value);
MUTUAL_SIMPLE_TEST(SignedUnsignedFunction, SingleBuiltinArgumentFunction, TestConstant,
                   5);
