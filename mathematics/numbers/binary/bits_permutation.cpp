...
#ifdef __GNUC__
SIMPLE_BENCHMARK(ClosestGreaterBitsPermutation_GNUC, Sample1, UPPER);
...
SIMPLE_BENCHMARK(ClosestGreaterBitsPermutation_Division, Sample1, UPPER);
...
SIMPLE_TEST(ClosestGreaterBitsPermutation_Division, TestSAMPLE1, 0b00011001u,
            0b00010110);
SIMPLE_TEST(ClosestGreaterBitsPermutation_Division, TestSAMPLE2, 0b00011100u,
            0b00011010);
...
SIMPLE_TEST(ClosestGreaterBitsPermutation_Arithmetic, TestSAMPLE1, 0b11011010001111,
            13948);
