...
MUTUAL_RANDOM_TEST(CountSetBits_BrianKernighan, CountSetBits_MagicBinaries32, LOWER,
                   UPPER);
...
SIMPLE_TEST(CountSetBitsFromMSB, TestUPPER, static_cast<unsigned>(CHAR_BIT), -1ULL,
            CHAR_BIT);
...
SIMPLE_TEST(SelectPositionWithCountFromMSB, TestSAMPLE1, 14u, 0x06FFFFFFFFFFFFFFULL,
            CHAR_BIT);
SIMPLE_TEST(SelectPositionWithCountFromMSB, TestSAMPLE2, 13u, 0x13FFFFFFFFFFFFFFULL,
            CHAR_BIT);
