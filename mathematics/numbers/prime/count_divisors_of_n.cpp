...
SIMPLE_BENCHMARK(HasOddNumberOfDivisors, 25);

SIMPLE_TEST(HasOddNumberOfDivisors, TestSAMPLE1, true, 25);
SIMPLE_TEST(HasOddNumberOfDivisors, TestSAMPLE2, false, 24);
SIMPLE_TEST(HasOddNumberOfDivisors, TestSAMPLE3, false, 18);
SIMPLE_TEST(HasOddNumberOfDivisors, TestSAMPLE4, true, 100);
