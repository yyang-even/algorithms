 ...
 * the integer by replacing it with the sum of its digits. Repeat the transform operation
 * k times in total.
 ...
 * following:
 *  Divide s into consecutive groups of size k such that the first k characters are in
 *      the first group, the next k characters are in the second group, and so on. Note
