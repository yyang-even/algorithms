...
const MatrixType SAMPLE1 = {{1, 1, 1}, {1, 0, 1}, {1, 1, 1}};
const MatrixType EXPECTED1 = {{1, 0, 1}, {0, 0, 0}, {1, 0, 1}};

const MatrixType SAMPLE2 = {{0, 1, 2, 0}, {3, 4, 5, 2}, {1, 3, 1, 5}};
const MatrixType EXPECTED2 = {{0, 0, 0, 0}, {0, 4, 5, 0}, {0, 3, 1, 0}};
