 ...
 *
 * Given an array arr[] of size n, its prefix sum array is another array prefixSum[] of same size such
...
static inline constexpr auto PrefixSumArray(
    ArrayType elements,
    const std::function<typename ArrayType::value_type(const typename ArrayType::value_type &,
