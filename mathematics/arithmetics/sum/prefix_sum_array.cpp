...
SIMPLE_BENCHMARK(RangesOfAdditions, SAMPLE3, 2, SAMPLE_RANGES3);

SIMPLE_TEST(RangesOfAdditions, TestSAMPLE3, EXPECTED3, SAMPLE3, 2, SAMPLE_RANGES3);


SIMPLE_BENCHMARK(RangesOfAdditions, 6, 100, SAMPLE_RANGES4);

SIMPLE_TEST(RangesOfAdditions, TestSAMPLE4, EXPECTED4, 6, 100, SAMPLE_RANGES4);


SIMPLE_BENCHMARK(MaxAfterRangesOfAdditions, 5, SAMPLE_RANGES5);
