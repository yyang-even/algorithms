...
SIMPLE_BENCHMARK(CheckPangram, "The quick brown fox jumps over the lazy dog.");
...
SIMPLE_BENCHMARK(CheckPangramConvertibleInK, "qwqqwqeqqwdsdadsdasadsfsdsdsdasasas", 24);
