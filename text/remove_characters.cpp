...
SIMPLE_TEST(RemoveCharactersByKey_Partition, TestSAMPLE1, "geeksforgeeeks",
            "g  eeks   for ge  eeks  ", ' ');
SIMPLE_TEST(RemoveCharactersByKey_Partition, TestSAMPLE2, "gksforgks", "geeksforgeeks",
            'e');
...
SIMPLE_BENCHMARK(RemoveCharactersPresentInTheSecond_Partition, Sample1, "geeksforgeeks",
                 "mask");
...
SIMPLE_BENCHMARK(RemoveCharactersAppearLessThanK_Partition, Sample1, "geeksforgeeks",
                 3);
