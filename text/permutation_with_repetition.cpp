 ...
 */
void PermutationWithRepetitionHelper(const std::string &input, const std::string &buffer, const std::string::iterator buffer_iter, std::vector<std::string> &outputs){
