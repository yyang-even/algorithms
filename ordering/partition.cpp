...
void Merge(const ArrayType::iterator begin,
    ...
    MergeTwoSortedArrays(
        L.cbegin(), L.cend(), R.cbegin(), R.cend(), begin, [](const auto lv, const auto rv) {
            if (lv < 0) {
                return true;
            } else if (rv < 0) {
                return false;
...
THE_BENCHMARK(RearrangePositiveAndNegativeNumbersAlternative_TwicePartition_Unstable, SAMPLE5);
...
THE_BENCHMARK(RearrangePositiveAndNegativeNumbersAlternative_SinglePartition_Unstable, SAMPLE5);
...
THE_BENCHMARK(RearrangePositiveAndNegativeNumbersAlternative_SinglePartition_Stable, SAMPLE5);
