...
auto CountingSort_NoNegative_STL(const ArrayType &values) {
...
SIMPLE_BENCHMARK(CountingSort_NoNegative_STL, VALUES6);

SIMPLE_TEST(CountingSort_NoNegative_STL, TestSAMPLE1, VALUES1, VALUES1);
SIMPLE_TEST(CountingSort_NoNegative_STL, TestSAMPLE2, VALUES2, VALUES2);
SIMPLE_TEST(CountingSort_NoNegative_STL, TestSAMPLE3, VALUES3, VALUES3);
SIMPLE_TEST(CountingSort_NoNegative_STL, TestSAMPLE4, EXPECTED4, VALUES4);
SIMPLE_TEST(CountingSort_NoNegative_STL, TestSAMPLE5, EXPECTED5, VALUES5);
SIMPLE_TEST(CountingSort_NoNegative_STL, TestSAMPLE6, EXPECTED6, VALUES6);
