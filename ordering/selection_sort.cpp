...
auto SelectionSort_SinglyList_Iterative(std::forward_list<ArrayType::value_type>
                                        values) {
...
auto SelectionSort_SinglyList_Recursive(std::forward_list<ArrayType::value_type>
                                        values) {
