 ...
 * (non-decreasing) if any of its elements can occur at a maximum of 1 distance
 * away from their original places in the sorted array. We need to find whether
 * the given array is almost sorted or not.
 */
