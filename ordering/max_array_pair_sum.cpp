 ...
 *  For example, given num = 2932, you have the following digits: two 2's, one 9 and one
 *      3. Some of the possible pairs [new1, new2] are [22, 93], [23, 92], [223, 9] and
 *      [2, 329].
 * Return the minimum possible sum of new1 and new2.
 * 1000 <= num <= 9999
 */
inline auto MinSum(int num) {
    ArrayType digits;
    while (num) {
