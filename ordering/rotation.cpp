...
auto LeftRotate_SinglyList(std::forward_list<int> elements,
    ...
    return SublistLeftRotate_SinglyList(elements, elements.cbefore_begin(), elements.cend(),
                                        k);
}
...
SIMPLE_TEST(LeftRotate_BlockSwap_Recursive, TestSample2, ExpectedArray2, SampleArray2,
            3);
...
SIMPLE_TEST(LeftRotate_BlockSwap_Iterative, TestSample2, ExpectedArray2, SampleArray2,
            3);
...
SIMPLE_TEST(MultipleLeftRotate_2n, TestSample, ExpectedMultiple5, SampleArray5,
            SampleQuery5);


SIMPLE_BENCHMARK(MultipleLeftRotate_n, Sample1, SampleArray5, SampleQuery5);

SIMPLE_TEST(MultipleLeftRotate_n, TestSample, ExpectedMultiple5, SampleArray5,
            SampleQuery5);
