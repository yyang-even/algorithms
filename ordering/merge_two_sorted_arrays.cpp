...
SIMPLE_BENCHMARK(MergeTwoSortedArraysToOnePartition, SAMPLE1LToOne, SAMPLE1LToOnePartition, SAMPLE1R);

SIMPLE_TEST(MergeTwoSortedArraysToOnePartition, TestSAMPLE1, EXPECTED1, SAMPLE1LToOnePartition, SAMPLE1R);
SIMPLE_TEST(MergeTwoSortedArraysToOnePartition, TestSAMPLE2, EXPECTED2, SAMPLE2LToOnePartition, SAMPLE2R);
SIMPLE_TEST(MergeTwoSortedArraysToOnePartition, TestSAMPLE5, EXPECTED5, SAMPLE5LToOnePartition, SAMPLE5R);
