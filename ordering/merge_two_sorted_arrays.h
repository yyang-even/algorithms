...
void MergeTwoSortedArrays(InputIter L_citer, const InputIter L_cend,
...
void MergeTwoSortedArrays(const ArrayType &L, const ArrayType &R, typename ArrayType::iterator output_iter){
    MergeTwoSortedArrays(L.cbegin(), L.cend(), R.cbegin(), R.cend(), output_iter, std::less<typename ArrayType::value_type>());
}

template<typename ArrayType>
void MergeTwoSortedArraysReverse(const ArrayType &L, const ArrayType &R, typename ArrayType::iterator output_iter){
    MergeTwoSortedArrays(L.crbegin(), L.crend(), R.crbegin(), R.crend(), output_iter, std::greater<typename ArrayType::value_type>());
}
